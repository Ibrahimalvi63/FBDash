    ...
    return (
        <div>
            ...
            <div className="min-h-screen bg-gray-200 text-gray-600">
                <div className="" style={{ backgroundImage: `url(https://res.cloudinary.com/doit4flte/image/upload/v1778953162/images_1_roikyh.jpg)`, backgroundSize: "cover", backgroundPosition: "center" }}>
                    <div className="p-5">
